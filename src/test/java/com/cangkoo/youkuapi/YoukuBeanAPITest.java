...
public class YoukuBeanAPITest {
	...
	public void testSearchVideoByKeyword() throws Exception {
		...
		result = api.searchVideoByKeyword(new String[] { "美国" }, 0, 0, null, null, null, null, null, null, null);
		...
		result = api.searchVideoByKeyword(new String[] { "美国" }, 2, 5, null, null, null, null, null, null, null);
		Assert.assertNotNull(result);
