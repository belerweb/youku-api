...
public final class APIConstant {
	 ...
	 * 视频聚合API:相关视频
	 */
	public static final String API_PTVIDEO_ST_3_STYPE_RELATED = "http://api.youku.com/api_ptvideo/st_3_stype_related?";

	/**
	 * 视频聚合API:CMS数据源列表聚合
	 */
	public static final String API_GETTOPICDSDATALIST_DS = "http://api.youku.com/api_getTopicDSDataList?datatp=ds&";

	/**
	 * 视频聚合API:CMS数据源视频聚合
	 */
	public static final String API_GETTOPICDSDATALIST = "http://api.youku.com/api_getTopicDSDataList?";
	 ...
	 * 用户API:站外自动注册登陆
	 */
	public static final String API_PTUSER_ACTION_LOGIN2 = "http://api.youku.com/api_ptuser/action_login2?";

	/**
	 * 用户API:站外用户与优酷用户绑定
	 */
	public static final String API_PTUSER_ACTION_BIND2 = "http://api.youku.com/api_ptuser/action_bind2?";
