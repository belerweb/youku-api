...
public final class YoukuBeanAPI extends YoukuAPI {
	...
	@Override
	public VideoSearchResult searchVideoByKeyword(String[] keywords, Integer page, Integer pageSize, Integer orderBy,
	...
	@Override
	public VideoSearchResult searchVideoByTag(String[] tags, Integer page, Integer pageSize, Integer orderBy,
